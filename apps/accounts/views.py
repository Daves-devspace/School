...
from apps.students.models import Class, Student, StudentParent
...
def generate_receipt(request, fee_record_id):
    ...
    context = {
        ...
        "student_grade": fee_record.student.grade.name,
        ...
        "payment_date": fee_record.due_date,
...
def generate_pdf_receipt(request, fee_record_id):
    ...
    context = {
        ...
        "student_last_name": fee_record.student.last_name,
        "student_grade": fee_record.student.grade.name,
        "guardian_name": guardian_names,  # Assuming this method exists
        "term_name": fee_record.term.name,
    ...
    # Render the receipt template to a string
    ...
    response["Content-Disposition"] = f"inline; filename=receipt_{fee_record.student.first_name}.pdf"
    return response
